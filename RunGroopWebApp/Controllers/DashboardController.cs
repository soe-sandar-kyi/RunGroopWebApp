...
namespace RunGroopWebApp.Controllers
{
    public class DashboardController : Controller
    {
        ...
        private void MapUserEdit(AppUser user,EditProfileViewModel editVM,ImageUploadResult photoResult)
        {
            user.Id = editVM.Id;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dashboarViewMode = new DashboardViewModel
            {
                Races = userRaces,
                Clubs = userClubs,
            };
            return View(dashboarViewMode);
        }
